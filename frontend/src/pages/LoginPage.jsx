    ...
    <div className="grid min-h-[78vh] items-center gap-8 lg:grid-cols-[0.9fr_1.1fr]">
      ...
      <section className="card mx-auto w-full max-w-md p-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black text-[#17313b]">Đăng nhập</h1>
          <p className="mt-1 font-bold text-[#6b7f86]">Tiếp tục tìm bạn đồng hành.</p>
        </div>

        <div className="mb-5 grid gap-3 sm:grid-cols-2">
          <button type="button" onClick={() => handleSocialLogin('Google')} className="btn-secondary py-3 text-sm">
            Gmail
          </button>
          <button type="button" onClick={() => handleSocialLogin('Facebook')} className="btn-secondary py-3 text-sm">
            Facebook
          </button>
        </div>
