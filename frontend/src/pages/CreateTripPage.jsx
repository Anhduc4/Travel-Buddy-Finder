...
export default function CreateTripPage() {
  const [form, setForm] = useState({ destination: '', description: '', startDate: '', endDate: '', maxPeople: 5, tags: '', imageUrl: '' });
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-lg font-bold text-[#6b7f86]">Viết rõ điểm đến, lịch trình, vibe, ảnh và số người để bạn đồng hành dễ quyết định.</p>
      </div>
      ...
      <div className="card p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="mb-2 block text-sm font-black text-[#526b73]">Ảnh chuyến đi</label>
